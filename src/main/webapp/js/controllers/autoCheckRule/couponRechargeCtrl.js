 ...
 * 充值返活动详情
 */
angular.module('inspinia',['uiSwitch']).controller('couponRechargeCtrl',function(i18nService,$scope,$http,$state,$stateParams,$compile,$filter,SweetAlert){
	...
	$scope.rechargeEntityGrid = {                  //配置表格
		    ...
		    columnDefs:[                        //表格数据
		       ...
		       { field: 'action',displayName:'操作',width:100,
			      	 cellTemplate:
			      		  '<span><a  class="lh30" ui-sref="func.couponRechargeDetailEdit({id:row.entity.id,view:\'view\'})" >详情</a><span>'
			      		 +'<span><a  class="lh30" ui-sref="func.couponRechargeDetailEdit({id:row.entity.id,view:\'edit\'})"> | 修改</a></span>'
			      		,width:130
			       }
		    ]
		};
