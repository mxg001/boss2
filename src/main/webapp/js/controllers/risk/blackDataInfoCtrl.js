 ...
 * 黑名单资料详情
 */
angular.module('inspinia').controller('blackDataInfoCtrl',function($scope,$http,i18nService,$state,$stateParams,$location){
    ...
    $scope.getBlackDataInfo = function () {
        $http({
            url: 'blackData/getDetail?id='+$stateParams.id,
            method:'POST'
