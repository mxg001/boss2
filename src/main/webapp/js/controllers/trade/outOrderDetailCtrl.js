 ...
 * 出款订单详情
 */
angular.module('inspinia').controller('outOrderDetailCtrl',function($scope,$http,$state,$stateParams,$compile,$log,i18nService){
...
//	$scope.settleTypes=[{text:"T0交易",value:'1'},{text:"手工提现",value:'2'},{text:"T1线上代付",value:'3'},{text:"T1线下代付",value:'4'}];
	...
	$scope.settleOrderStatuss=[{text:"未确认",value:'0'},{text:"已确认",value:'1'},{text:"确认失败",value:'2'}];
	 $http.get('settleOrderInfoAction/selectInfoDetail?ids='+$stateParams.id)
