 ...
 * 修改产品
 */
angular.module('inspinia',['angularFileUpload']).controller("updateInsuranceProductCtrl", function($scope, $http, $state, $stateParams,FileUploader) {
    //数据源
    ...
    $scope.submit = function(){
        ...
        $http({
            url: "insuranceProduct/updateProduct",
            method: "POST",
            data: $scope.baseInfo
        }).success(function(result){
