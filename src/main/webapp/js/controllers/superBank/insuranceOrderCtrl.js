 ...
 * 贷款订单查询
 */
angular.module('inspinia', ['infinity.angular-chosen']).controller('insuranceOrderCtrl',function($scope,$http,i18nService,$document,SweetAlert){
    //数据源
    ...
    $scope.resetForm = function () {
        $scope.baseInfo = {orderType:"15",status:"",orgId:-1,companyNo:-1,productType :"",orderPhone:"",orderName:"",
            orderIdNo:"",userCode:"",userName:"", sharePhone:"",
    ...
    $scope.columnDefs = [
        ...
        {field: 'price',displayName: '保单金额',width: 150,pinnable: false,sortable: false,cellFilter:'currency:""'},
        {field: 'bonusSettleTime',displayName: '奖金结算时间',width: 150,pinnable: false,sortable: false},
        {field: 'bxzongAmount',displayName: '保险总奖金',width: 140,pinnable: false,sortable: false,cellFilter:'currency:""'},
...
//		rowHeight:35,
    ...
    $scope.query = function () {
        ...
        $scope.loadImg = true;
        $http({
            url: 'insuranceOrder/orderManager?pageNo='+$scope.paginationOptions.pageNo+'&pageSize='+$scope.paginationOptions.pageSize,
            data: $scope.baseInfo,
            method:'POST'
    ...
    $scope.exportInfo = function () {
        SweetAlert.swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    location.href="insuranceOrder/exportInsuranceOrder?baseInfo=" +encodeURI(encodeURI(angular.toJson($scope.baseInfo)));
                }
            });
    };
