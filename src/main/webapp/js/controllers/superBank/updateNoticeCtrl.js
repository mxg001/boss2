 ...
 * 修改公告
 */
angular.module('inspinia',['angularFileUpload']).controller("updateNoticeCtrl", function($scope, $http, $state, $stateParams,FileUploader) {
