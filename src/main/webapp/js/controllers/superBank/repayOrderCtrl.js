 ...
 * 还款订单查询
 */
angular.module('inspinia',['infinity.angular-chosen']).controller('repayOrderCtrl',function($scope,$http,i18nService,$document,SweetAlert,$timeout){
    //数据源
    ...
    $scope.repayTransStatusList = [{text:"全部",value:""},{text:"成功",value:"3"},{text:"失败",value:"4"},{text:"终止",value:"6"}];//记账状态
    $scope.orderTypeList = [{text:"全部",value:"7,17"},{text:"分期计划",value:"7"},{text:"完美计划",value:"17"}];//类型
    $scope.resetForm = function () {
        $scope.baseInfo = {orderType:"7,17",status:"",orgId:-1,oneUserCode:"",oneUserType:"",repayTransStatus:"",
    ...
    $scope.columnDefs = [
        ...
        {field: 'orderType',displayName: '类型',width: 150,pinnable: false,sortable: false},
        ...
        {field: 'repayTransStatus',displayName: '还款状态',width: 150,pinnable: false,sortable: false},
        ...
        {field: 'repaymentAgentId',displayName: '还款商户ID',width: 150,pinnable: false,sortable: false},
        {field: 'payOrderNo',displayName: '关联还款订单号',width: 250,pinnable: false,sortable: false},
        {field: 'receiveAmount',displayName: '目标还款金额',width: 250,pinnable: false,sortable: false,cellFilter: 'number:2'},
        {field: 'repaymentAmount',displayName: '实际还款金额',width: 250,pinnable: false,sortable: false,cellFilter: 'number:2'},
        {field: 'repayTransscucons',displayName: '实际消费金额',width: 250,pinnable: false,sortable: false,cellFilter: 'number:2'},
        {field: 'repayTransCardNo',displayName: '还款卡号',width: 250,pinnable: false,sortable: false},
        {field: 'transRate',displayName: '用户还款费率',width: 250,pinnable: false,sortable: false},
        {field: 'repayTransfee',displayName: '用户还款手续费',width: 250,pinnable: false,sortable: false,cellFilter: 'number:2'},
        {field: 'loanOrgRate',displayName: '品牌还款代理费率',width: 250,pinnable: false,sortable: false},
        {field: 'loanOrgBonus',displayName: '品牌发放总奖金扣率',width: 250,pinnable: false,sortable: false},
        {field: 'totalBonus',displayName: '品牌发放总奖金',width: 140,pinnable: false,sortable: false},
        {field: 'repayTransChannel',displayName: '还款通道',width: 140,pinnable: false,sortable: false},
        {field: 'companyCostRate',displayName: '公司成本扣率',width: 140,pinnable: false,sortable: false},
        ...
        // {field: 'recId',displayName: '红包Id',width: 150,pinnable: false,sortable: false,cellFilter:"currency:''"},
        // {field: 'redAmount',displayName: '发红包金额',width: 150,pinnable: false,sortable: false,cellFilter:"currency:''"},
...
//		rowHeight:35,
    ...
    $scope.exportInfo = function () {
        SweetAlert.swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    location.href="superBank/exportRepayOrder?baseInfo=" +encodeURI(encodeURI(angular.toJson($scope.baseInfo)));
                }
            });
    };
