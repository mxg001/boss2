...
angular.module('inspinia',['infinity.angular-chosen','angularFileUpload']).controller('workTypeAdd',function($scope,$http,$state,$stateParams,i18nService,$timeout,FileUploader){
