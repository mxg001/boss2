...
angular.module('inspinia',['infinity.angular-chosen','angularFileUpload']).controller('workTypeEditCtrl',function($scope,$http,$state,$stateParams,i18nService,$timeout,FileUploader){
