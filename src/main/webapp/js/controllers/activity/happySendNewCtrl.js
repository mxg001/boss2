 ...
 * 新欢乐送商户查询
 */
angular.module('inspinia',['angularFileUpload','infinity.angular-chosen']).controller('happySendNewCtrl',function($scope,$http,$state,$stateParams,i18nService,$document,SweetAlert,FileUploader,$timeout){
    //数据源
    i18nService.setCurrentLang('zh-cn');
    $scope.paginationOptions=angular.copy($scope.paginationOptions);
    $scope.baseInfo = {activeOrder:"",currentCycle:"",currentTargetStatus:"",activityTargetStatus:"",containsLower:"0",merchantNo:"",agentNo:"",subType:"2"};
    ...
    $scope.currentTargetStatusList = [{text:'全部',value:''},{text:'未开始',value:'0'},{text:'考核中',value:'1'},{text:'已达标',value:'2'},{text:'未达标',value:'3'},{text:'未达标返代理商',value:'4'},{text:'已达标奖励商户',value:'5'}];
            ...
            function (isConfirm) {
                if (isConfirm) {
                    if($scope.activityGrid.data==null || $scope.activityGrid.data.length==0){
                        ...
                        // location.href = "activityDetail/exportHappySendNew?baseInfo=" + encodeURI(angular.toJson($scope.baseInfo)) + "&pageNo=" + $scope.paginationOptions.pageNo + "&pageSize=" + +$scope.paginationOptions.pageSize;
